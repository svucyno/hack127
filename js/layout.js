...
function buildLayout(pageTitle) {
  const nav = [
    ...
    { href: "../pages/inventory.html",  key: "Inventory",  label: "Inventory" },
    { href: "../pages/billing.html",    key: "Billing",    label: "Billing" },
    { href: "../pages/alerts.html",     key: "Alerts",     label: "Alerts" },
    { href: "../pages/offers.html",     key: "Offers",     label: "Offers" },
    { href: "../pages/reports.html",    key: "Reports",    label: "Reports" },
    { href: "../pages/customers.html",  key: "Customers",  label: "Customers" },
    { href: "../pages/suppliers.html",  key: "Suppliers",  label: "Suppliers" },
  ];
        ...
        <div class="sidebar-footer">
          <div class="sidebar-user">
            ...
            <div class="user-info">
              ...
              <span id="user-role">Store Owner</span>
            </div>
          </div>
